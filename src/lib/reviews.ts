...
export async function getReviewsForMechanic(
  ...
  try {
    ...
    return (data || []).map((review: any) => ({
      ...
      professionalism_rating: review.professionalism_rating ?? null,
      communication_rating: review.communication_rating ?? null,
      performance_rating: review.performance_rating ?? null,
      timing_rating: review.timing_rating ?? null,
      cost_rating: review.cost_rating ?? null,
      punctuality_rating: review.punctuality_rating ?? null,
      payment_rating: review.payment_rating ?? null,
