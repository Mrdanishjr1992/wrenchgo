-- =====================================================
-- FIX GET_PUBLIC_PROFILE_CARD RPC
-- =====================================================
-- Purpose: Update the RPC to return the correct schema matching PublicProfileCard type
-- Returns: ratings object, badges array, skills array, display_name
-- =====================================================
