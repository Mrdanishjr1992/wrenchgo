-- =====================================================
-- FIX RPC RETURN TYPE - CAST STATUS TO TEXT
-- =====================================================
-- Purpose: Fix the get_mechanic_leads RPC to cast status enum to text
-- Issue: Function returns job_status enum but signature expects text
-- =====================================================

-- Drop and recreate the get_mechanic_leads function with proper type casting
