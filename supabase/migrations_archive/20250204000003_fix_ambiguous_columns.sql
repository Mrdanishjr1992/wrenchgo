-- =====================================================
-- FIX AMBIGUOUS COLUMN REFERENCES IN RPC
-- =====================================================
-- Purpose: Fix ambiguous job_id column references in get_mechanic_leads RPC
-- Issue: Subqueries need table aliases to avoid ambiguity
-- =====================================================

-- Drop and recreate the get_mechanic_leads function with proper aliases
...
-- Drop and recreate the summary function with proper aliases
