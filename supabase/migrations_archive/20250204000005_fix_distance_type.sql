-- =====================================================
-- FIX RPC DISTANCE TYPE - CAST TO NUMERIC
-- =====================================================
-- Purpose: Fix the get_mechanic_leads RPC to cast distance to numeric
-- Issue: Distance calculation returns double precision but function expects numeric
-- =====================================================

-- Drop and recreate the get_mechanic_leads function with proper distance type casting
