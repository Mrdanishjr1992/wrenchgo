-- =====================================================
-- FIX GET_PUBLIC_PROFILE_CARD RPC - USE REVIEWS TABLE CORRECTLY
-- =====================================================
-- Purpose: Query reviews table properly with correct foreign key references
-- =====================================================
...
BEGIN
  ...
  -- Get skills data (for mechanics only) using auth_id
  SELECT COALESCE(jsonb_agg(
    jsonb_build_object(
      'id', ms.id,
      'level', ms.level,
