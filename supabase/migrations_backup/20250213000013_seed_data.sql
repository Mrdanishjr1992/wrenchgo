-- ============================================================================
-- Migration: 20250213000013_seed_data.sql
-- ============================================================================
-- Purpose: Seed data for lookup tables (skills, tools, symptoms, etc.)
-- Dependencies: 20250111000001 (skills, tools, safety_measures, symptoms, 
--               symptom_mappings, education_cards, symptom_education, 
--               symptom_questions, media_assets tables)
-- Risk Level: Low (idempotent with ON CONFLICT)
-- Rollback: DELETE FROM tables (data only, no schema changes)
-- Source: supabase/migrations_backup/0014_seed_data.sql
-- ============================================================================
