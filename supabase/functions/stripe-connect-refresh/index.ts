...
body{font-family:system-ui,sans-serif;min-height:100vh;display:flex;align-items:center;justify-content:center;background:#f5576c;color:#fff;text-align:center;padding:20px}
.box{background:rgba(255,255,255,.15);padding:40px;border-radius:16px;max-width:360px}
h1{font-size:24px;margin-bottom:12px}
p{opacity:.85;margin-bottom:24px}
a{display:inline-block;background:#fff;color:#f5576c;padding:12px 28px;border-radius:24px;text-decoration:none;font-weight:600}
</style>
</head>
<body>
<div class="box">
