-- =====================================================
-- MIGRATION 4: MESSAGING AND MEDIA
-- =====================================================
...
COMMENT ON TABLE public.notifications IS 'User notifications with type and entity tracking';
COMMENT ON COLUMN public.notifications.type IS 'Notification type (e.g., "job_quote", "message_received")';
COMMENT ON COLUMN public.notifications.entity_type IS 'Related entity type (e.g., "job", "quote")';
COMMENT ON COLUMN public.notifications.entity_id IS 'Related entity ID';
...
CREATE INDEX IF NOT EXISTS idx_media_assets_bucket_path ON public.media_assets(bucket, path) WHERE deleted_at IS NULL;
