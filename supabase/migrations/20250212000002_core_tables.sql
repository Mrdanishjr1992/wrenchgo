...
COMMENT ON COLUMN public.profiles.city IS 'User city for display purposes';
...
COMMENT ON TABLE public.jobs IS 'Job requests from customers';
COMMENT ON COLUMN public.jobs.preferred_time IS 'Customer preferred time as text (e.g., "Morning", "Afternoon")';
