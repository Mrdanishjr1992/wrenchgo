...
// These assume you already have these two files:
// app/(mechanic)/(tabs)/messages.tsx
// app/(mechanic)/(tabs)/notifications.tsx
...
export default function Inbox() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      {/* Content */}
      <View style={{ flex: 1 }}>{tab === "messages" ? <Messages /> : <Notifications />}</View>
    </View>
  );
}
