...
export default function QuoteComposer() {
  ...
  const handleContinue = () => {
    ...
    // Combine the selected date + time into a single timestamp we can store in the DB.
    // We pass both a display-friendly label and an ISO timestamp.
    const proposedStart = new Date(arrivalDate);
    proposedStart.setHours(arrivalTime.getHours(), arrivalTime.getMinutes(), 0, 0);
