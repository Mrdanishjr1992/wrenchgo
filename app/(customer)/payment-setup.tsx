  ...
  const setupPaymentMethod = useCallback(async () => {
    try {
      ...
      const { error: initError } = await initPaymentSheet({
        ...
        returnURL: "wrenchgo://payment-setup",
      });
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: spacing.lg }}>
          ...
          {hasPaymentMethod && paymentMethod ? (
            ...
            <>
              ...
              <Text style={{ ...text.muted, textAlign: "center", marginBottom: spacing.lg, lineHeight: 22 }}>
                To use WrenchGo's services, please add a payment method. Your card will only be charged when you accept a quote and complete a service.
              </Text>
            </>
          )}
        </View>
        ...
        <View style={{ marginTop: spacing.xl, padding: spacing.md }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={{ ...text.body, flex: 1 }}>Only charged when you approve</Text>
          </View>
        </View>
      </ScrollView>
    </View>
