      ...
      >
        ...
        >
          <View style={{ flex: 1, gap: 4 }}>
            <Text style={[text.h3, { color: colors.text }]}>Hubs & Coverage</Text>
            <Text style={[text.small, { color: colors.textSecondary }]}>View hub ranges and current mechanic/customer counts.</Text>
          </View>
